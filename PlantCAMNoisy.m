function dqdt=PlantCAMNoisy(tt,q,Us,Uf,ts,tf)

for i=1:2
    m(i)=(Uf(i)-Us(i))/(tf-ts);
    uu(i,1)=m(i)*(tt-ts)+Us(i);
end
U=uu;

Ms=1.02;Rs=.306;Is=0.0612;d=.153;
Ir1=.008;Ir2=.004;Mr=0.7;Mc=0.7;
%
%*******************************************************************************
%
x=q(1);y=q(2);r1=q(3);r2=q(4);r3=q(5);r4=q(6);
%
%*******************************************************************************
%
A=zeros(6);
